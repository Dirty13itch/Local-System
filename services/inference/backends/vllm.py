...
logger = setup_logging("inference.vllm")
...
class VLLMBackend(InferenceBackend):
    ...
    def __init__(self, settings: Settings) -> None:
        self.base_url = settings.inference.vllm_host
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.info(f"vLLM connected at {self.base_url}")
        except Exception as e:
            logger.warning(f"vLLM not available at {self.base_url}: {e}")
