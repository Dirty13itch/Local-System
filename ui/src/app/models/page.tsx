...
const GPU_ASSIGNMENTS: Record<string, string> = {
  reasoning: "GPU 0-3 (RTX 5070 Ti x4, TP=4)",
  coding: "GPU 0-3 (RTX 5070 Ti x4, TP=4)",
  utility: "GPU 0-3 (RTX 5070 Ti x4, TP=4)",
  fast: "GPU 0-3 (RTX 5070 Ti x4, TP=4)",
  creative: "GPU 0-3 (RTX 5070 Ti x4, TP=4)",
  worker: "GPU 0-3 (RTX 5070 Ti x4, TP=4)",
